...
const LINKS = [
  ...
  { href: '/trips/busan-2026/invite?empty=1', label: '초대 (참여 전)' },
  { href: '/trips/busan-2026/invite', label: '초대 (참여 후)' },
  ...
  return (
    <PageContainer className="flex flex-col items-start gap-6 py-16">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-body-base text-text-subtle">PWA 모바일 폭에서 확인해 주세요.</p>
      </div>
